...
**Observations**: - Write your observations here! - The distinctness and
count are exactly the same, but the mean velocity is slightly different
(maximum of +/- 2 km/s off)

Why might your table differ from Michelson’s? - I think the mean
velocity might differ because the tools they used for calculating means
of numbers is less precise than what we have now, thus, Michelson’s
table is rounded to the 10s place.
...
of the error (51) is less than the true error (151.542)

Make a quantitative comparison between Michelson’s uncertainty and his
error. - The difference between Michellson’s uncertainty and his error
is 100.542 km/s, which is around ~300% of his estimated error
...
**Observations**: Similarities - the mean across all days, and the upper
and lower control limits (UCL and LCL) are similar across both plots.
The overall shape of the grey line showing the mean for each day also
has a similar shape across both plots.

Differences - The data points for the simulated data generally vary more
across one day than the real data.
...
date, distinctness (3 is best quality), temp, velocityvacuum
...
- By plotting VelocityVacuum against Temp, it seems that the velocity
  increases slightly as temperature increases. Maybe Michelson’s offset
  of +92km/s to account for air, doesn’t account for the temperature of
  the air, which changes the density of the air and thus how fast the
  light travels.
- I didn’t notice anything in the other two plots that might help
  explain the difference in Michelson’s error and uncertainty. However,
  I noticed that VelocityVacuum generally decreases as Date increases. I
  don’t think it decreases because he gets better at the experiment, as
  I would expect Distinctness to increase with Date as well. So I’m
  curious why this trend exists.
