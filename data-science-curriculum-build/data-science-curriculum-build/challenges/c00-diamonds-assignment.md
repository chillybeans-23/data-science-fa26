...
- Price increases with carat, but the price “steps up” at weight values
  that humans consider to be nice, such as 0.5, 1, 2
...
- price increases as the cut value goes from fair to ideal
- assuming there are no limits on the vertical axis of the plot, there
  are no diamonds with carat above 3.5 that are also ideal cut
